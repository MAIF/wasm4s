...
These guidelines apply to all Otoroshi projects living in the the `MAIF/wasm4s` repository.
...
* [lib](https://github.com/MAIF/wasm4s/lib): contains static libs
* [src](https://github.com/MAIF/wasm4s/src): contains the wasm4s sources and tests
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/MAIF/wasm4s/issues) and [existing pull requests](https://github.com/MAIF/wasm4s/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/MAIF/wasm4s/issues/new) to discuss the problem and the approach you want to take to solve it.
1. [Fork the project](https://github.com/MAIF/wasm4s#fork-destination-box) on GitHub. You'll need to create a feature-branch for your work on your fork, as this way you'll be able to submit a pull request against the mainline Otoroshi.
