...
private[wasm4s] object implicits {

  private[wasm4s] implicit class BetterSyntax[A](private val obj: A) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterString(private val obj: String) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterByteString(private val obj: ByteString) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterBoolean(private val obj: Boolean) extends AnyVal {
    def json: JsValue = JsBoolean(obj)
  }

  private[wasm4s] implicit class BetterDouble(private val obj: Double) extends AnyVal {
    def json: JsValue = JsNumber(obj)
  }

  private[wasm4s] implicit class BetterInt(private val obj: Int) extends AnyVal {
    def json: JsValue = JsNumber(obj)
  ...
  private[wasm4s] implicit class BetterLong(private val obj: Long) extends AnyVal {
    def json: JsValue = JsNumber(obj)
  ...
  private[wasm4s] implicit class BetterJsValue(private val obj: JsValue) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterJsValueOption(private val obj: Option[JsValue]) extends AnyVal {
    def orJsNull: JsValue = obj.getOrElse(JsNull)
  }

  private[wasm4s] implicit class BetterJsLookupResult(private val obj: JsLookupResult) extends AnyVal {
    def select(name: String): JsLookupResult = obj \ name
  ...
  private[wasm4s] implicit class BetterJsReadable(private val obj: JsReadable) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterFuture[A](private val obj: Future[A]) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterMapOfStringAndB[B](val theMap: Map[String, B]) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterTrieMapOfStringAndB[B](val theMap: TrieMap[String, B]) extends AnyVal {
  ...
  private[wasm4s] implicit class BetterSeqOfA[A](val seq: Seq[A]) extends AnyVal {
